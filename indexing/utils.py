...
def encode_image_base64(image_path: str | Path) -> tuple[str, str] | None:
    """
    Load and base64-encode a page image.

    Images larger than 4 MB are re-compressed as JPEG quality 85 to stay
    under the Anthropic API 5 MB limit.

    Returns ``(base64_data, media_type)`` or *None* if the file doesn't exist.
    """
    import base64
    import io
    ...
    # Re-compress oversized images as JPEG, lowering quality until under 4 MB
